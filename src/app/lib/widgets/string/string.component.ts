...
export class StringComponent extends LfbControlWidgetComponent implements OnInit, AfterViewInit {
  ...
  modifiedMessages = {
    PATTERN: [
      ...
      {
        pattern: '^(0[1-9]|[1-2][0-9]|3[0-1])\/(0[1-9]|1[0-2])\/([0-9]([0-9]([0-9][1-9]|[1-9]0)|[1-9]00)|[1-9]000)$',
        message: 'Valid format is DD/MM/YYYY.'
      },
      {
        pattern: '^(0[1-9]|[1-2][0-9]|3[0-1])-(0[1-9]|1[0-2])-([0-9]([0-9]([0-9][1-9]|[1-9]0)|[1-9]00)|[1-9]000)$',
        message: 'Valid format is DD-MM-YYYY.'
      ...
      {
        pattern: '^(0[1-9]|1[0-2])\/(0[1-9]|[1-2][0-9]|3[0-1])\/([0-9]([0-9]([0-9][1-9]|[1-9]0)|[1-9]00)|[1-9]000)$',
        message: 'Valid format is MM/DD/YYYY.'
      },
      {
        pattern: '^(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])-([0-9]([0-9]([0-9][1-9]|[1-9]0)|[1-9]00)|[1-9]000)$',
        message: 'Valid format is MM-DD-YYYY.'
      ...
      {
        pattern: '^([0-9]([0-9]([0-9][1-9]|[1-9]0)|[1-9]00)|[1-9]000)\/(0[1-9]|1[0-2])\/(0[1-9]|[1-2][0-9]|3[0-1]) ([01][0-9]|2[0-3]):[0-5][0-9]:([0-5][0-9])$',
        message: 'Valid format is YYYY/MM/DD HH:MM:SS.'
      },
      {
        pattern: '^(0[1-9]|[1-2][0-9]|3[0-1])\/(0[1-9]|1[0-2])\/([0-9]([0-9]([0-9][1-9]|[1-9]0)|[1-9]00)|[1-9]000) ([01][0-9]|2[0-3]):[0-5][0-9]:([0-5][0-9])$',
        message: 'Valid format is DD/MM/YYYY HH:MM:SS.'
      },
      {
        pattern: '^(0[1-9]|[1-2][0-9]|3[0-1])-(0[1-9]|1[0-2])-([0-9]([0-9]([0-9][1-9]|[1-9]0)|[1-9]00)|[1-9]000) ([01][0-9]|2[0-3]):[0-5][0-9]:([0-5][0-9])$',
        message: 'Valid format is DD-MM-YYYY HH:MM:SS.'
      ...
      {
        pattern: '^(0[1-9]|1[0-2])\/(0[1-9]|[1-2][0-9]|3[0-1])\/([0-9]([0-9]([0-9][1-9]|[1-9]0)|[1-9]00)|[1-9]000) ([01][0-9]|2[0-3]):[0-5][0-9]:([0-5][0-9])$',
        message: 'Valid format is MM/DD/YYYY HH:MM:SS.'
      },
      {
        pattern: '^(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])-([0-9]([0-9]([0-9][1-9]|[1-9]0)|[1-9]00)|[1-9]000) ([01][0-9]|2[0-3]):[0-5][0-9]:([0-5][0-9])$',
        message: 'Valid format is MM-DD-YYYY HH:MM:SS.'
